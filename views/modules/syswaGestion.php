...
<div class="page">
      ...
      <section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(views/images/jumbotron-1-1919x953.jpg);">
        <div class="container">
          ...
          <div class="breadcrumbs-custom-subtitle">Continua para informarte sobre nuestro sistema de gestión</div>
        </div>
      </section>
      <!-- Blurb minimal-->
            ...
            <div class="col-lg-5 col-xl-4">
              <div class="row row-30 row-xxl-55 justify-content-end">
                <div class="col-sm-6 col-lg-9 col-xl-10 text-lg-right">
                  ...
                  <div class="big-text">Tenemos un montón de funcionalidades que harán que tu negocio sea fácil de administrar.</div>
                ...
                <div class="col-sm-6 col-lg-8 col-xl-7">
                  <div class="counter-minimal">
                    ...
                    <div class="counter-right">
                      ...
                      <div class="title">Clientes contentos</div>
                    </div>
                  </div>
      ...
      <!-- pdf -->
      <section class="section section-sm bg-gray-700 text-center text-sm-left">
        <div class="container">
          <div class="row">
            <div class="col-md-10">
            ...
            <div class="col-md-2">
              <div class="button-wrap"><a download class="button button-default button-invariable" href="views/images/Syswa_Gestion_Manual_de_Usuario.pdf" target="_blank">Descargar</a></div>
            </div>
          </div>
        </div>
      </section>
