	...
	<div class="page">
      ...
      <section class="section section-xl-custom image-section section-lined">
        ...
        <div class="image-container">
          <div class="mock-up-1">
            <div class="object object-1"><img class="wow fadeInRight" src="views/images/image-custom-1-395x243.jpg" alt="" width="395" height="243"/>
            </div>
            <div class="object object-2"><img class="wow fadeInRight" src="views/images/image-custom-2-384x189.jpg" alt="" width="384" height="189" data-wow-delay="0.2s"/>
            </div>
            <div class="object object-3"><img class="wow fadeInRight" src="views/images/image-custom-3-395x243.jpg" alt="" width="395" height="243" data-wow-delay="0.4s"/>
            </div>
            ...
            <div class="object object-5"><img class="wow fadeInRight" src="views/images/image-custom-5-395x243.jpg" alt="" width="395" height="243" data-wow-delay="0.2s"/>
            </div>
            <div class="object object-6"><img class="wow fadeInRight" src="views/images/image-custom-6-275x184.jpg" alt="" width="275" height="184" data-wow-delay="0.4s"/>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="swiper-section">
          <div class="swiper-container swiper-slider swiper-slider-1" data-next=".custom-swiper-button-next" data-prev=".custom-swiper-button-prev" data-loop="true">
            <div class="swiper-wrapper">
              <div class="swiper-slide" data-slide-bg="views/images/home-1-585x541.jpg"></div>
              <div class="swiper-slide" data-slide-bg="views/images/home-2-585x541.jpg"></div>
            </div>
            ...
            <div class="col-lg-7 col-xl-8">
              <div class="row no-gutters">
                <div class="col-sm-6 wow fadeInLeft">
                  <div class="box-team box-team-right"><img src="views/images/index-3-1-390x332.jpg" alt="" width="390" height="332"/>
                    <div class="meta">
                ...
                <div class="col-sm-6 wow fadeInRight">
                  <div class="box-team box-team-right"><img src="views/images/index-3-2-390x332.jpg" alt="" width="390" height="332"/>
                    <div class="meta">
                ...
                <div class="col-sm-6 wow fadeInLeft" data-wow-delay="0.2s">
                  <div class="box-team box-team-right"><img src="views/images/index-3-3-390x332.jpg" alt="" width="390" height="332"/>
                    <div class="meta">
                ...
                <div class="col-sm-6 wow fadeInRight" data-wow-delay="0.2s">
                  <div class="box-team box-team-right"><img src="views/images/index-3-4-390x332.jpg" alt="" width="390" height="332"/>
                    <div class="meta">
